...
public class SimpleController {
    ...
    public String basic(Model model){
        ...
        person.setPhoneNumber("532674317");
    ...
    private List<Person> generateList(){
        ...
        person1.setPhoneNumber("532674317");
        ...
        person2.setLastName("Cebula");
        person2.setPhoneNumber("689732098");
        person2.setSalary(1500.00);
        person2.setVisible(false);
        list.add(person2);

        Person person3 = new Person();
        person3.setFirstName("Monika");
        person3.setLastName("Kowalska");
        person3.setPhoneNumber("785472076");
